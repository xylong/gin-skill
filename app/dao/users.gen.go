...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.Address = userHasManyAddress{
		...
		RelationField: field.NewRelation("Address", "models.Address"),
	}

	_user.Profile = userHasOneProfile{
		db: db.Session(&gorm.Session{}),

		RelationField: field.NewRelation("Profile", "models.UserProfile"),
	}
...
func (a userHasManyAddress) Model(m *models.User) *userHasManyAddressTx {
	return &userHasManyAddressTx{a.db.Model(m).Association(a.Name())}
}

type userHasManyAddressTx struct{ tx *gorm.Association }

func (a userHasManyAddressTx) Find() (result []*models.Address, err error) {
	return result, a.tx.Find(&result)
}

func (a userHasManyAddressTx) Append(values ...*models.Address) (err error) {
...
func (a userHasManyAddressTx) Replace(values ...*models.Address) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a userHasManyAddressTx) Delete(values ...*models.Address) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a userHasOneProfileTx) Find() (result *models.UserProfile, err error) {
	return result, a.tx.Find(&result)
}

func (a userHasOneProfileTx) Append(values ...*models.UserProfile) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a userHasOneProfileTx) Replace(values ...*models.UserProfile) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a userHasOneProfileTx) Delete(values ...*models.UserProfile) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
