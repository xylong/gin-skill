...
func newUserProfile(db *gorm.DB, opts ...gen.DOOption) userProfile {
	...
	_userProfile.userProfileDo.UseModel(&models.UserProfile{})
...
type IUserProfileDo interface {
	...
	Create(values ...*models.UserProfile) error
	CreateInBatches(values []*models.UserProfile, batchSize int) error
	Save(values ...*models.UserProfile) error
	First() (*models.UserProfile, error)
	Take() (*models.UserProfile, error)
	Last() (*models.UserProfile, error)
	Find() ([]*models.UserProfile, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.UserProfile, err error)
	FindInBatches(result *[]*models.UserProfile, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.UserProfile) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.UserProfile, error)
	FirstOrCreate() (*models.UserProfile, error)
	FindByPage(offset int, limit int) (result []*models.UserProfile, count int64, err error)
...
func (u userProfileDo) Create(values ...*models.UserProfile) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userProfileDo) CreateInBatches(values []*models.UserProfile, batchSize int) error {
	return u.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (u userProfileDo) Save(values ...*models.UserProfile) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userProfileDo) First() (*models.UserProfile, error) {
...
func (u userProfileDo) Take() (*models.UserProfile, error) {
...
func (u userProfileDo) Last() (*models.UserProfile, error) {
...
func (u userProfileDo) Find() ([]*models.UserProfile, error) {
	result, err := u.DO.Find()
	return result.([]*models.UserProfile), err
}

func (u userProfileDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.UserProfile, err error) {
	buf := make([]*models.UserProfile, 0, batchSize)
...
func (u userProfileDo) FindInBatches(result *[]*models.UserProfile, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (u userProfileDo) FirstOrInit() (*models.UserProfile, error) {
...
func (u userProfileDo) FirstOrCreate() (*models.UserProfile, error) {
...
func (u userProfileDo) FindByPage(offset int, limit int) (result []*models.UserProfile, count int64, err error) {
...
func (u userProfileDo) Delete(models ...*models.UserProfile) (result gen.ResultInfo, err error) {
